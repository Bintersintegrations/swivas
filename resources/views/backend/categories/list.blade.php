                                ...
                                <table class="jsgrid-table">
                                    ...
                                    @foreach ($categories->where('parent_id',null) as $grandparent)
                                        <tr class="jsgrid-row">
                                            ...
                                            <td class="jsgrid-cell jsgrid-align-right" style="width: 50px;">{{$grandparent->products->count()}}</td>
                                        ...
                                        @foreach ($categories->where('parent_id',$grandparent->id) as $parent)
                                            <tr class="jsgrid-row">
                                                ...
                                                <td class="jsgrid-cell jsgrid-align-right" style="width: 50px;">{{$parent->products->count()}}</td>
                                                <td class="jsgrid-cell" style="width: 50px;">
                                            ...
                                            @foreach ($categories->where('parent_id',$parent->id) as $child)
                                                <tr class="jsgrid-row">
                                                    ...
                                                    <td class="jsgrid-cell jsgrid-align-right" style="width: 50px;">{{$child->products->count()}}</td>
                                                    <td class="jsgrid-cell" style="width: 50px;">
