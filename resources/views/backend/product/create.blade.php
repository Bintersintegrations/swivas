                            ...
                            <form class="needs-validation add-product-form" method="POST" action="{{route('admin.items.product.save')}}">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <textarea name="description" class="form-control col-xl-8 col-sm-7" cols="10" rows="6"></textarea>
                                    </div>
                                </div>

                                <div class="form">
                                    <div class="form-group row">
                                        <label for="categories" class="col-xl-3 col-sm-4 mb-0">Select Category :</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="form-group row color">
                                                    <label for="color" class="col-6 mb-0">Select Color :</label>
                                                    <select class="form-control digits col-6" id="color" name="color[]">
                                                        @foreach($colors as $color)
                                                            <option value="{{$color->hex}}" style="background-color:{{$color->hex}}">{{$color->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    <label for="validationCustom02" class="col-6 mb-0">Price :</label>
                                                    <input class="form-control col-6" id="validationCustom02" type="text" required="" name="price[]">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
