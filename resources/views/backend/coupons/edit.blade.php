...
<div class="container-fluid">
    <div class="card tab2-card">
        ...
        <div class="card-body">
            ...
            <form class="needs-validation" action="{{route('admin.coupons.update',$coupon)}}" method="POST">@csrf
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input class="datepicker-here form-control digits col-md-7" name="start_date" value="{{$coupon->start_at ? $coupon->start_at->toDateString(): old('start_date')}}" type="text" data-language="en">
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-md-4">End Date</label>
                                    <input class="datepicker-here form-control digits col-md-7" name="end_date" value="{{$coupon->end_at ? $coupon->start_at->toDateString() : old('end_date')}}" type="text" data-language="en">
                                </div>
