                        ...
                        <div class="col-12">
                            <form class="needs-validation add-product-form" method="POST" action="{{route('admin.items.product.save')}}">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-group mb-3 row">
                                        <label for="value" class="col-xl-3 col-sm-4 mb-0">Instant Price :</label>
                                        <input class="form-control col-xl-8 col-sm-7" id="value" name="value" type="number" required>
                                    </div>
                                    <div class="form-group mb-3 row">
                                        <label for="minimum" class="col-xl-3 col-sm-4 mb-0">Minimum Bid :</label>
                                        <input class="form-control col-xl-8 col-sm-7" id="minimum" name="minimum" type="number" required>
                                    </div>
                                    <div class="form-group mb-3 row">
                                        <label for="condition" class="col-xl-3 col-sm-4 mb-0">Condition :</label>
                                        <select class="form-control col-xl-8 col-sm-7" id="condition" name="condition" required>
                                            <option selected>New</option>
                                            <option>Used</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-3 row">
                                        <label for="pickup" class="col-xl-3 col-sm-4 mb-0">Allow Places</label>
                                        <select class="form-control col-xl-8 col-sm-7" id="condition" name="condition" required>
