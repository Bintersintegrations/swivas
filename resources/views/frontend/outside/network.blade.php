...
@section('main')
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="{{asset('assets/images/about/about%20us.jpg')}}"
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        <div>
                            <div>
                                <img src="{{asset('assets/images/team/1.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                        ...
                        <div>
                            <div>
                                <img src="{{asset('assets/images/team/2.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="{{asset('assets/images/team/3.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="{{asset('assets/images/team/4.jpg')}}" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
