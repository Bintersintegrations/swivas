                                ...
                                <div class="product-right">
                                    ...
                                    <div class="product-description border-product">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <img
                                                            src="{{asset('assets/images/size-chart.jpg')}}" alt=""
                                                            class="img-fluid blur-up lazyload">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="qty-box">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="quantity" class="form-control input-number" value="1" id="quantity"> 
                                                <span class="input-group-prepend">
                                    ...
                                    <div class="product-buttons">
                                        ...
                                        <form class="d-inline-block" action="{{route('checkout')}}" method="POST" id="buynowform">@csrf
                                            ...
                                            <button type="button" class="btn btn-solid" id="buynow">buy now</button>
                                        </form>
                                    ...
                                    <div class="border-product">
                                        ...
                                        <div class="product-icon">
                                            ...
                                            <form class="d-inline-block">
                                                <button class="wishlist-btn" id="add-to-wish"><i class="fa fa-heart"></i><span
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-top-tab" data-toggle="tab"
                                            href="#top-contact" role="tab" aria-selected="false"><i
                                                class="icofont icofont-contacts"></i>Media</a>
                                        <div class="material-border"></div>
                                    </li>
    ...
    <script>
        ...
        $(document).on('click','.color-options',function(){
            ...
            e.preventDefault();
                ...
                clicked_color = $(this).attr('data-color');
            }
        });
        $(document).on('click','.labelled_size',function(e){
            if($(this).hasClass('disabled'))
            e.preventDefault();
            else{
        ...
        $(document).on('click','#buynow',function(e){
            if(clicked_color != '' && clicked_size == '') product_id = getProductByColor(clicked_color); 
            if(clicked_size != '' && clicked_color == '') product_id = getProductBySize(clicked_size);
            if(clicked_color != '' && clicked_size != '' ) product_id = getProductByColorSize(clicked_color,clicked_size);
            quantity = $('#quantity').val();
            $('#variant_id').val(product_id);
            $('#variant_quantity').val(quantity);
            $('#buynowform').submit();      
        });
        ...
        function getProductBySize(clicked_size){
            var variant;
            $.each(options, function( key, value ) {
                if(JSON.stringify(value).includes(clicked_size)){
                    variant = key;
                    return false;
                }
            });
        ...
        function getProductByColor(clicked_color){
            var variant;
            $.each(options, function( key, value ) {
                if(JSON.stringify(value).includes(clicked_color)){
                    variant = key;
                    return false;
                }
            });
        ...
        function getProductByColorSize(clicked_color,clicked_size){
            var variant;
            $.each(options, function( key, value ) {
                if(JSON.stringify(value).includes(clicked_color) && JSON.stringify(value).includes(clicked_size)){
                    variant = key;
                    return false;
                }
            });
