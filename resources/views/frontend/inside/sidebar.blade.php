    ...
    <div class="faq-tab">
        <ul class="nav nav-tabs" id="top-tab" role="tablist">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('vendor.giving.create')}}">New Giveaway</a>
                    <a class="dropdown-item" href="{{route('vendor.givings')}}">All Giveaways</a>
                    <a class="dropdown-item" href="{{route('vendor.giving.granted')}}">Requests Granted</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('vendor.auction.create')}}">New Auction</a>
                    <a class="dropdown-item" href="{{route('vendor.auctions')}}">All Auctions</a>
                    <a class="dropdown-item" href="{{route('vendor.auction.awarded')}}">Bids Awarded</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
