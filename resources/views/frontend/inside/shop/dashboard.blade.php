                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table-responsive-md table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row"><img src="{{asset('assets/images/pro3/1.jpg')}}"
                                                            class="blur-up lazyloaded"></th>
                                                ...
                                                <tr>
                                                    <th scope="row"><img src="{{asset('assets/images/pro3/27.jpg')}}"
                                                            class="blur-up lazyloaded"></th>
                                                    <td>men print tee</td>
                                                    <td>men clothes</td>
                                                    <td>$150</td>
                                                ...
                                                <tr>
                                                    <th scope="row"><img src="{{asset('assets/images/pro3/36.jpg')}}"
                                                            class="blur-up lazyloaded"></th>
                                                    <td>men print tee</td>
                                                    <td>men clothes</td>
                                                    <td>$150</td>
