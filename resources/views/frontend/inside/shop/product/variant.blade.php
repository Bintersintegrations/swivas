                                                                                ...
                                                                                <div class="row mt-3">
                                                                                    <div class="col-lg-6 col-sm-12 col-xs-12">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <textarea class="form-control" rows="3" name="description" readonly placeholder="Some details about the product" required>{{$product->description}}</textarea>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="categories" class="form-label">Select Category :</label>
                                                                                            <select class="form-control select2" id="category" name="categories[]" multiple disabled>
