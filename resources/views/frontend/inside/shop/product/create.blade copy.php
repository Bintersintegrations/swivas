                                                        ...
                                                        <div class="row">
                                                            @forelse ($atributes as $atribute)
                                                                @if ($atribute->element == 'textbox')
                                                                    <div class="form-group col-6 atributes {{$atribute->slug}}" style="display:none">
                                                                        <label class="mb-0 mr-1">{{$atribute->description}}:</label>
                                                                        <input class="form-control" type="text" data-role="tagsinput" name="atributes[{{$atribute->slug}}]" id="{{$atribute->slug}}">
                                                                    </div>
                                                                @endif
